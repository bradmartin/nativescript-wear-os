    ...
    export module wearable {
      export module activity {
        export class WearableActivityDelegate {
          ...
          >;
          public constructor(
            param0: android.support.wearable.activity.WearableActivityDelegate.AmbientCallback
          );
          public setAutoResumeEnabled(param0: boolean): void;
          public setAmbientOffloadEnabled(param0: boolean): void;
          public onPause(): void;
        ...
        export module WearableActivityDelegate {
          ...
          export class AmbientOffloadCallback extends android.support.wearable
            .activity.WearableActivityDelegate.AmbientCallback {
            public static class: java.lang.Class<
      ...
      export module authentication {
        ...
        export module IAuthenticationRequestCallback {
          export abstract class Stub
            extends android.support.wearable.internal.aidl.BaseStub
            implements
            ...
            public static asInterface(
              param0: android.os.IBinder
            ): android.support.wearable.authentication.IAuthenticationRequestCallback;
            public dispatchTransaction(
              param0: number,
              param1: android.os.Parcel,
              param2: android.os.Parcel,
              param3: number
            ): boolean;
            public onResult(param0: android.os.Bundle): void;
          ...
          export module Stub {
            export class Proxy
              extends android.support.wearable.internal.aidl.BaseProxy
              implements
                android.support.wearable.authentication
                  .IAuthenticationRequestCallback {
              public static class: java.lang.Class<
    ...
    export module wearable {
      export module authentication {
        export class IAuthenticationRequestService {
          ...
          public constructor(implementation: {
            openUrl(
              param0: android.os.Bundle,
              param1: android.support.wearable.authentication.IAuthenticationRequestCallback
            ): void;
          });
          public constructor();
          public openUrl(
      ...
      export module authentication {
        export class OAuthClient {
          ...
          public sendAuthorizationRequest(
            ...
            param1: android.support.wearable.authentication.OAuthClient.Callback
          ): void;
          public static create(
            param0: android.content.Context
          ): android.support.wearable.authentication.OAuthClient;
          public constructor(
            param0: android.support.wearable.authentication.OAuthClient.ServiceBinder,
        ...
        export module OAuthClient {
          export abstract class Callback {
            ...
            public onAuthorizationResponse(
              param0: android.net.Uri,
          ...
          export class OAuthConnection {
            public static class: java.lang.Class<
              android.support.wearable.authentication.OAuthClient.OAuthConnection
            >;
            public onServiceConnected(
              param0: android.content.ComponentName,
              param1: android.os.IBinder
            ): void;
            public onServiceDisconnected(
              param0: android.content.ComponentName
            ): void;
          }
          export class RequestCallback extends android.support.wearable
            .authentication.IAuthenticationRequestCallback.Stub {
            public static class: java.lang.Class<
              android.support.wearable.authentication.OAuthClient.RequestCallback
            >;
            public onResult(param0: android.os.Bundle): void;
          }
          export class ServiceBinder {
            public static class: java.lang.Class<
              android.support.wearable.authentication.OAuthClient.ServiceBinder
            >;
            /**
            ...
            public constructor(implementation: {
              bindService(
                ...
                param1: android.content.ServiceConnection,
                param2: number
              ): boolean;
            ...
            public unbindService(
              param0: android.content.ServiceConnection
            ): void;
            public bindService(
              param0: android.content.Intent,
              param1: android.content.ServiceConnection,
      ...
      export module complications {
        ...
        export module ComplicationData {
          export class Builder {
            ...
            public setImageStyle(
              param0: number
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setShortText(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setLongText(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            ...
            public setBurnInProtectionIcon(
              param0: any
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setLargeImage(
              param0: any
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setTapAction(
              param0: android.app.PendingIntent
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setBurnInProtectionSmallImage(
              param0: any
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setSmallImage(
              param0: any
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setValue(
              param0: number
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setContentDescription(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            public constructor(
              param0: android.support.wearable.complications.ComplicationData
            );
            public constructor(param0: number);
            public setLongTitle(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setShortTitle(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setImageContentDescription(
              param0: android.support.wearable.complications.ComplicationText
            ): android.support.wearable.complications.ComplicationData.Builder;
            public setStartTime(
              param0: number
          ...
          export class ComplicationType {
            public static class: java.lang.Class<
              android.support.wearable.complications.ComplicationData.ComplicationType
            >;
            /**
    ...
    export module wearable {
      export module complications {
        export class ComplicationHelperActivity {
          ...
          public constructor();
          public onCreate(param0: android.os.Bundle): void;
          public static createPermissionRequestHelperIntent(
            param0: android.content.Context,
            param1: android.content.ComponentName
          ): android.content.Intent;
          public static createProviderChooserHelperIntent(
            param0: android.content.Context,
            param1: android.content.ComponentName,
            param2: number,
    ...
    export module wearable {
      export module complications {
        export class ComplicationManager {
          ...
          public constructor(
            param0: android.support.wearable.complications.IComplicationManager
          );
          public updateComplicationData(
            param0: number,
            param1: android.support.wearable.complications.ComplicationData
          ): void;
        }
      }
    }
      ...
      export module complications {
        export abstract class ComplicationProviderService {
          ...
          public onComplicationActivated(
            param0: number,
            param1: number,
            param2: android.support.wearable.complications.ComplicationManager
          ): void;
        ...
        export module ComplicationProviderService {
          export class IComplicationProviderWrapper extends android.support
            .wearable.complications.IComplicationProvider.Stub {
            public static class: java.lang.Class<
...
declare module android {
  export module support {
    export module wearable {
      export module complications {
        export class ComplicationText extends android.support.wearable
          .complications.TimeDependentText {
          public static class: java.lang.Class<
          ...
          public static getText(
            param0: android.content.Context,
            param1: android.support.wearable.complications.ComplicationText,
            param2: number
          ): string;
        }
        export module ComplicationText {
          export class TimeDifferenceBuilder {
            ...
            public setReferencePeriodEnd(
              param0: number
            ): android.support.wearable.complications.ComplicationText.TimeDifferenceBuilder;
            public setReferencePeriodStart(
              param0: number
            ): android.support.wearable.complications.ComplicationText.TimeDifferenceBuilder;
            public setSurroundingText(
              param0: string
            ): android.support.wearable.complications.ComplicationText.TimeDifferenceBuilder;
            public setShowNowText(
              param0: boolean
            ): android.support.wearable.complications.ComplicationText.TimeDifferenceBuilder;
            public build(): android.support.wearable.complications.ComplicationText;
            public setMinimumUnit(
              param0: java.util.concurrent.TimeUnit
            ): android.support.wearable.complications.ComplicationText.TimeDifferenceBuilder;
          }
          export class TimeDifferenceStyle {
            public static class: java.lang.Class<
              android.support.wearable.complications.ComplicationText.TimeDifferenceStyle
            >;
            /**
          ...
          export class TimeFormatBuilder {
            ...
            public setTimeZone(
              param0: java.util.TimeZone
            ): android.support.wearable.complications.ComplicationText.TimeFormatBuilder;
          }
          export class TimeFormatStyle {
            public static class: java.lang.Class<
              android.support.wearable.complications.ComplicationText.TimeFormatStyle
            >;
            /**
...
declare module android {
  export module support {
    export module wearable {
      export module complications {
        export class ComplicationTextTemplate extends android.support.wearable
          .complications.TimeDependentText {
          public static class: java.lang.Class<
    ...
    export module wearable {
      export module complications {
        export class ComplicationTextUtils {
          ...
          >;
          public static shortTextDayOfWeekFormat(
            param0: java.util.Locale
          ): string;
          public static shortTextDayOfMonthFormat(
            param0: java.util.Locale
          ): string;
          public static shortTextDayMonthFormat(
            param0: java.util.Locale
          ): string;
          public constructor();
          public static shortTextTimeFormat(
            param0: java.util.Locale,
            param1: boolean
          ): string;
    ...
    export module wearable {
      export module complications {
        export class ProviderChooserIntent {
          ...
          public static startProviderChooserActivity(
            param0: android.content.Context,
            param1: android.content.ComponentName,
            param2: number,
            param3: native.Array<number>
          ): void;
          public static createProviderChooserIntent(
            param0: android.content.ComponentName,
            param1: number,
            param2: native.Array<number>
          ): android.content.Intent;
    ...
    export module wearable {
      export module complications {
        export class ProviderInfoRetriever {
          ...
          public retrieveProviderInfo(
            param0: android.support.wearable.complications.ProviderInfoRetriever.OnProviderInfoReceivedCallback,
            param1: android.content.ComponentName,
            param2: native.Array<number>
          ): void;
          public init(): void;
        ...
        export module ProviderInfoRetriever {
          export abstract class OnProviderInfoReceivedCallback {
            ...
            >;
            public onProviderInfoReceived(
              param0: number,
              param1: android.support.wearable.complications.ComplicationProviderInfo
            ): void;
            public constructor();
    ...
    export module wearable {
      export module complications {
        export class TimeDependentText {
          public static class: java.lang.Class<
            android.support.wearable.complications.TimeDependentText
          >;
          /**
...
declare module android {
  export module support {
    export module wearable {
      export module complications {
        export class TimeDifferenceText extends android.support.wearable
          .complications.TimeDependentText {
          public static class: java.lang.Class<
          ...
          public constructor(
            ...
            param2: number,
            param3: boolean,
            param4: java.util.concurrent.TimeUnit
          );
          public getText(
            param0: android.content.Context,
            param1: number
...
declare module android {
  export module support {
    export module wearable {
      export module complications {
        export class TimeFormatText extends android.support.wearable
          .complications.TimeDependentText {
          public static class: java.lang.Class<
      ...
      export module complications {
        export module rendering {
          export class ComplicationDrawable {
            ...
            public setTextTypefaceAmbient(
              param0: android.graphics.Typeface
            ): void;
            ...
            public setBackgroundDrawableAmbient(
            ...
            public setBackgroundDrawableActive(
              param0: android.graphics.drawable.Drawable
            ): void;
            ...
            public setImageColorFilterActive(
              param0: android.graphics.ColorFilter
            ): void;
            public setBorderWidthAmbient(param0: number): void;
            public setImageColorFilterAmbient(
              param0: android.graphics.ColorFilter
            ): void;
            ...
            public setTextTypefaceActive(
              param0: android.graphics.Typeface
            ): void;
            public setBorderRadiusActive(param0: number): void;
            public setTitleTypefaceActive(
              param0: android.graphics.Typeface
            ): void;
            public constructor(
              param0: android.support.wearable.complications.rendering.ComplicationDrawable
            );
            public setHighlightColorActive(param0: number): void;
            public setTitleTypefaceAmbient(
              param0: android.graphics.Typeface
            ): void;
      ...
      export module complications {
        export module rendering {
          export class ComplicationRenderer {
            public static class: java.lang.Class<
              android.support.wearable.complications.rendering.ComplicationRenderer
            >;
            public setRangedValueProgressHidden(param0: boolean): void;
            public setOnInvalidateListener(
              param0: android.support.wearable.complications.rendering.ComplicationRenderer.OnInvalidateListener
            ): void;
            public setComplicationData(
              param0: android.support.wearable.complications.ComplicationData
            ): void;
            public updateStyle(
              param0: android.support.wearable.complications.rendering.ComplicationStyle,
              param1: android.support.wearable.complications.rendering.ComplicationStyle
            ): void;
            public setNoDataText(param0: string): void;
            public constructor(
              param0: android.content.Context,
              param1: android.support.wearable.complications.rendering.ComplicationStyle,
              param2: android.support.wearable.complications.rendering.ComplicationStyle
            );
            public draw(
          ...
          export module ComplicationRenderer {
            export class OnInvalidateListener {
              public static class: java.lang.Class<
                android.support.wearable.complications.rendering.ComplicationRenderer.OnInvalidateListener
              >;
              /**
               ...
               */
              public constructor(implementation: { onInvalidate(): void });
              public constructor();
              public onInvalidate(): void;
            }
            export class PaintSet {
              public static class: java.lang.Class<
                android.support.wearable.complications.rendering.ComplicationRenderer.PaintSet
              >;
            }
          }
        }
      ...
      export module complications {
        export module rendering {
          export class ComplicationStyle {
            public static class: java.lang.Class<
              android.support.wearable.complications.rendering.ComplicationStyle
            >;
          ...
          export module ComplicationStyle {
            export class Builder {
              public static class: java.lang.Class<
                android.support.wearable.complications.rendering.ComplicationStyle.Builder
              >;
              public static CREATOR: android.os.Parcelable.Creator<
                android.support.wearable.complications.rendering.ComplicationStyle.Builder
              >;
              ...
              public setRangedValueSecondaryColor(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setTitleColor(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setRangedValuePrimaryColor(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setBorderStyle(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setBorderDashGap(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public constructor(
                param0: android.support.wearable.complications.rendering.ComplicationStyle.Builder
              );
              ...
              public describeContents(): number;
              public setRangedValueRingWidth(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setTextSize(
                param0: number
              ...
              public setBorderDashWidth(
                param0: number
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setTextTypeface(
                param0: android.graphics.Typeface
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
              public setTitleTypeface(
                param0: android.graphics.Typeface
              ): android.support.wearable.complications.rendering.ComplicationStyle.Builder;
      ...
      export module complications {
        export module rendering {
          export class EmojiHelper {
            public static class: java.lang.Class<
              android.support.wearable.complications.rendering.EmojiHelper
            >;
          }
        }
      }
      ...
      export module complications {
        export module rendering {
          export class RoundedDrawable {
            public static class: java.lang.Class<
              android.support.wearable.complications.rendering.RoundedDrawable
            >;
            public draw(param0: android.graphics.Canvas): void;
            public constructor();
            public setColorFilter(param0: android.graphics.ColorFilter): void;
      ...
      export module complications {
        export module rendering {
          export class TextRenderer {
            ...
            public setEllipsize(
              param0: android.text.TextUtils.TruncateAt
            ): void;
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class IconLayoutHelper extends android.support.wearable
              .complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class LargeImageLayoutHelper extends android.support.wearable
              .complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
          ...
          export module utils {
            export class LayoutHelper {
              ...
              public update(
                param0: number,
                param1: number,
                param2: android.support.wearable.complications.ComplicationData
              ): void;
        ...
        export module rendering {
          export module utils {
            export class LayoutUtils {
              public static class: java.lang.Class<
                android.support.wearable.complications.rendering.utils.LayoutUtils
              >;
              public constructor();
              public static getLeftPart(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static getRightPart(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static isWideRectangle(
                param0: android.graphics.Rect
              ): boolean;
              public static getInnerBounds(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect,
                param2: number
              ): void;
              public static getBottomHalf(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static getCentralSquare(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static getTopHalf(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static fitSquareToBounds(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect
              ): void;
              public static scaledAroundCenter(
                param0: android.graphics.Rect,
                param1: android.graphics.Rect,
                param2: number
              ): void;
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class LongTextLayoutHelper extends android.support.wearable
              .complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class RangedValueLayoutHelper extends android.support
              .wearable.complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class ShortTextLayoutHelper extends android.support.wearable
              .complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
  ...
  export module support {
    export module wearable {
      export module complications {
        export module rendering {
          export module utils {
            export class SmallImageLayoutHelper extends android.support.wearable
              .complications.rendering.utils.LayoutHelper {
              public static class: java.lang.Class<
      ...
      export module input {
        ...
        export module RemoteInputConstants {
          export class InputActionType {
            public static class: java.lang.Class<
              android.support.wearable.input.RemoteInputConstants.InputActionType
            >;
            /**
    ...
    export module wearable {
      export module input {
        export class WearableButtons {
          ...
          >;
          public static getButtonIcon(
            param0: android.content.Context,
            param1: number
          ): android.graphics.drawable.Drawable;
          public static getButtonLabel(
            param0: android.content.Context,
            param1: number
          ): string;
      ...
      export module internal {
        export module aidl {
          export abstract class BaseProxy {
            public static class: java.lang.Class<
              android.support.wearable.internal.aidl.BaseProxy
            >;
      ...
      export module internal {
        export module aidl {
          export abstract class BaseStub {
            public static class: java.lang.Class<
              android.support.wearable.internal.aidl.BaseStub
            >;
            public asBinder(): android.os.IBinder;
            public routeToSuperOrEnforceInterface(
              param0: number,
              param1: android.os.Parcel,
              param2: android.os.Parcel,
              param3: number
    ...
    export module wearable {
      export module internal {
        export module aidl {
          export class Codecs {
            public static class: java.lang.Class<
              android.support.wearable.internal.aidl.Codecs
            >;
            ...
            public static createParcelable(
              param0: android.os.Parcel,
              param1: android.os.Parcelable.Creator
            ): android.os.Parcelable;
            public static writeCharSequenceAsReturnValue(
              param0: android.os.Parcel,
              param1: string
            ): void;
            public static writeParcelable(
              param0: android.os.Parcel,
              param1: android.os.Parcelable
            ): void;
            public static createCharSequence(param0: android.os.Parcel): string;
            public static writeCharSequence(
              param0: android.os.Parcel,
              param1: string
            ): void;
            public static writeParcelableAsReturnValue(
              param0: android.os.Parcel,
              param1: android.os.Parcelable
            ): void;
            public static readMap(
              param0: android.os.Parcel,
              param1: java.util.Map<any, any>
            ): void;
            ...
            public static writeStrongBinder(
              param0: android.os.Parcel,
              param1: android.os.IInterface
            ): void;
          }
        }
      }
      ...
      export module internal {
        export module aidl {
          export class TransactionInterceptor {
            public static class: java.lang.Class<
              android.support.wearable.internal.aidl.TransactionInterceptor
            >;
            /**
            ...
            public constructor(implementation: {
              interceptTransaction(
                param0: android.support.wearable.internal.aidl.BaseStub,
                param1: number,
                param2: android.os.Parcel,
                param3: android.os.Parcel,
                param4: number
              ): boolean;
            });
            public constructor();
            public interceptTransaction(
              param0: android.support.wearable.internal.aidl.BaseStub,
              param1: number,
              param2: android.os.Parcel,
              param3: android.os.Parcel,
      ...
      export module internal {
        export module view {
          export class SwipeDismissLayout {
            public static class: java.lang.Class<
              android.support.wearable.internal.view.SwipeDismissLayout
            >;
            public static DEFAULT_DISMISS_DRAG_WIDTH_RATIO: number;
            public setDismissMinDragWidthRatio(param0: number): void;
            public setOnDismissedListener(
              param0: android.support.wearable.internal.view.SwipeDismissLayout.OnDismissedListener
            ): void;
            public cancel(): void;
            public constructor(
              param0: android.content.Context,
            ...
            public setOnPreSwipeListener(
              param0: android.support.wearable.internal.view.SwipeDismissLayout.OnPreSwipeListener
            ): void;
            public setOnSwipeProgressChangedListener(
              param0: android.support.wearable.internal.view.SwipeDismissLayout.OnSwipeProgressChangedListener
            ): void;
          ...
          export module SwipeDismissLayout {
            export class OnDismissedListener {
              ...
              public constructor(implementation: {
                onDismissed(
                  param0: android.support.wearable.internal.view.SwipeDismissLayout
                ): void;
              });
              public constructor();
              public onDismissed(
      ...
      export module internal {
        export module view {
          export class SwipeDismissPreferenceFragment {
            ...
            public constructor();
            public onCreateView(
              param0: android.view.LayoutInflater,
              param1: android.view.ViewGroup,
              param2: android.os.Bundle
            ): android.view.View;
      ...
      export module internal {
        export module view {
          export module drawer {
            export class MultiPagePresenter extends android.support.wearable
              .internal.view.drawer.WearableNavigationDrawerPresenter {
              public static class: java.lang.Class<
                android.support.wearable.internal.view.drawer.MultiPagePresenter
              >;
              public onNewAdapter(
                param0: android.support.wearable.view.drawer.WearableNavigationDrawer.WearableNavigationDrawerAdapter
              ): void;
              ...
              public constructor(
                param0: android.support.wearable.view.drawer.WearableNavigationDrawer,
                param1: android.support.wearable.internal.view.drawer.MultiPagePresenter.Ui,
                param2: boolean
              );
            }
            export module MultiPagePresenter {
              export class Ui {
                ...
                public constructor(implementation: {
                  initialize(
                    param0: android.support.wearable.view.drawer.WearableNavigationDrawer,
                    param1: android.support.wearable.internal.view.drawer.WearableNavigationDrawerPresenter
                  ): void;
  ...
  export module support {
    export module wearable {
      export module internal {
        export module view {
          export module drawer {
            export class MultiPageUi extends android.support.wearable.internal
              .view.drawer.MultiPagePresenter.Ui {
              public static class: java.lang.Class<
  ...
  export module support {
    export module wearable {
      export module internal {
        export module view {
          export module drawer {
            export class SinglePagePresenter extends android.support.wearable
              .internal.view.drawer.WearableNavigationDrawerPresenter {
              public static class: java.lang.Class<
                android.support.wearable.internal.view.drawer.SinglePagePresenter
              >;
              public onNewAdapter(
                param0: android.support.wearable.view.drawer.WearableNavigationDrawer.WearableNavigationDrawerAdapter
              ): void;
              ...
              public onSelected(param0: number): void;
              public constructor(
                param0: android.support.wearable.internal.view.drawer.SinglePagePresenter.Ui,
                param1: boolean
              );
              public onDataSetChanged(): void;
              public onSetCurrentItemRequested(
            ...
            export module SinglePagePresenter {
              export class Ui {
                public static class: java.lang.Class<
                  android.support.wearable.internal.view.drawer.SinglePagePresenter.Ui
                >;
                /**
                ...
                public constructor(implementation: {
                  setPresenter(
                    param0: android.support.wearable.internal.view.drawer.WearableNavigationDrawerPresenter
                  ): void;
  ...
  export module support {
    export module wearable {
      export module internal {
        export module view {
          export module drawer {
            export class SinglePageUi extends android.support.wearable.internal
              .view.drawer.SinglePagePresenter.Ui {
              public static class: java.lang.Class<
                android.support.wearable.internal.view.drawer.SinglePageUi
              >;
              public initialize(param0: number): void;
              public constructor(
                param0: android.support.wearable.view.drawer.WearableNavigationDrawer
            ...
            export module SinglePageUi {
              export class OnSelectedClickHandler {
                public static class: java.lang.Class<
                  android.support.wearable.internal.view.drawer.SinglePageUi.OnSelectedClickHandler
                >;
        ...
        export module view {
          export module drawer {
            export class WearableNavigationDrawerPresenter {
              public static class: java.lang.Class<
                android.support.wearable.internal.view.drawer.WearableNavigationDrawerPresenter
              >;
              /**
      ...
      export module notifications {
        ...
        export module BridgingConfig {
          export class Builder {
            ...
            public addExcludedTags(
              param0: java.util.Collection<string>
            ): android.support.wearable.notifications.BridgingConfig.Builder;
    ...
    export module wearable {
      export module notifications {
        export class BridgingManager {
          ...
          >;
          public setConfig(
            param0: android.support.wearable.notifications.BridgingConfig
          ): void;
    ...
    export module wearable {
      export module phone {
        export class PhoneDeviceType {
          ...
          public constructor();
          public static getPhoneDeviceType(
            param0: android.content.Context
          ): number;
        }
    ...
    export module wearable {
      export module playstore {
        export class OpenRemotePlayStoreIntent {
          public static class: java.lang.Class<
            android.support.wearable.playstore.OpenRemotePlayStoreIntent
          >;
    ...
    export module wearable {
      export module preference {
        export class AcceptDenyDialogPreference {
          ...
          public setOnDialogClosedListener(
            param0: android.support.wearable.preference.AcceptDenyDialogPreference.OnDialogClosedListener
          ): void;
          ...
          public onPrepareDialog(
            param0: android.support.wearable.view.AcceptDenyDialog
          ): void;
          public showDialog(param0: android.os.Bundle): void;
          public onClick(
            param0: android.content.DialogInterface,
            param1: number
          ): void;
    ...
    export module wearable {
      export module preference {
        export class PreferenceIconHelper {
          ...
          >;
          public static wrapAllIconsInGroup(
            param0: android.preference.PreferenceGroup
          ): void;
          public static wrapIcon(param0: android.preference.Preference): void;
          public static wrapIcon(
            param0: android.content.Context,
            param1: android.graphics.drawable.Drawable
          ): android.graphics.drawable.Drawable;
        }
    ...
    export module wearable {
      export module preference {
        export class WearableDialogPreference {
          ...
          public setPositiveIcon(
            param0: android.graphics.drawable.Drawable
          ): void;
          public setNeutralIcon(
            param0: android.graphics.drawable.Drawable
          ): void;
          public getNegativeIcon(): android.graphics.drawable.Drawable;
          public onPrepareDialogBuilder(
            param0: android.app.AlertDialog.Builder
          ): void;
          ...
          public setOnDialogClosedListener(
            param0: android.support.wearable.preference.WearableDialogPreference.OnDialogClosedListener
          ): void;
          public setNeutralIcon(param0: number): void;
          public setNegativeIcon(
            param0: android.graphics.drawable.Drawable
          ): void;
...
declare module android {
  export module support {
    export module wearable {
      export module preference {
        export class WearablePreferenceActivity extends android.support.wearable
          .activity.WearableActivity {
          public static class: java.lang.Class<
            android.support.wearable.preference.WearablePreferenceActivity
          >;
          public onStart(): void;
          public onBuildStartFragmentIntent(
            param0: string,
          ...
          public constructor();
          public onCreate(param0: android.os.Bundle): void;
          public startPreferenceFragment(
            param0: android.app.Fragment,
            param1: boolean
          ): void;
          public onPreferenceStartFragment(
            param0: android.preference.PreferenceFragment,
            param1: android.preference.Preference
          ): boolean;
        }
      }
    }
    ...
    export module wearable {
      export module view {
        export class AcceptDenyDialog {
          ...
          public setPositiveButton(
            param0: android.content.DialogInterface.OnClickListener
          ): void;
          public constructor(param0: android.content.Context, param1: number);
          public constructor(param0: android.content.Context);
          public setIcon(param0: number): void;
          public setTitle(param0: string): void;
          public setNegativeButton(
            param0: android.content.DialogInterface.OnClickListener
          ): void;
          ...
          public setButton(
            param0: number,
            param1: android.content.DialogInterface.OnClickListener
          ): void;
        }
      }
    }
    ...
    export module wearable {
      export module view {
        ...
        export module AcceptDenyDialogFragment {
          export class Builder {
            public static class: java.lang.Class<
              android.support.wearable.view.AcceptDenyDialogFragment.Builder
            >;
            public static CREATOR: android.os.Parcelable.Creator<
              android.support.wearable.view.AcceptDenyDialogFragment.Builder
            >;
            ...
            public apply(
              param0: android.support.wearable.view.AcceptDenyDialogFragment
            ): android.support.wearable.view.AcceptDenyDialogFragment;
    ...
    export module wearable {
      export module view {
        export class ActionChooserView {
          ...
          public addListener(
            param0: android.support.wearable.view.ActionChooserView.ActionChooserListener
          ): void;
        ...
        export module ActionChooserView {
          ...
          export class Option {
            public static class: java.lang.Class<
              android.support.wearable.view.ActionChooserView.Option
            >;
            public color: number;
    ...
    export module wearable {
      export module view {
        export class ActionPage {
          ...
          public setStateListAnimator(
            param0: android.animation.StateListAnimator
          ): void;
          ...
          public setOnClickListener(
            param0: android.view.View.OnClickListener
          ): void;
          public setText(param0: string): void;
          public constructor(param0: android.content.Context);
          public constructor(
    ...
    export module wearable {
      export module view {
        export class BackgroundController
          ...
          public static class: java.lang.Class<
            android.support.wearable.view.BackgroundController
          >;
          ...
          public onAdapterChanged(
            param0: android.support.wearable.view.GridPagerAdapter,
            param1: android.support.wearable.view.GridPagerAdapter
          ): void;
        ...
        export module BackgroundController {
          export class Direction {
            public static class: java.lang.Class<
              android.support.wearable.view.BackgroundController.Direction
            >;
      ...
      export module view {
        ...
        export module BoxInsetLayout {
          export class LayoutParams {
            ...
            public constructor(
              param0: android.support.wearable.view.BoxInsetLayout.LayoutParams
            );
    ...
    export module wearable {
      export module view {
        export class CardFrame {
          ...
          public static EXPAND_DOWN: number;
          public getContentPaddingRight(): number;
          public onInitializeAccessibilityEvent(
            param0: android.view.accessibility.AccessibilityEvent
          ): void;
          public getContentPaddingLeft(): number;
          public onAttachedToWindow(): void;
          ...
          public onInitializeAccessibilityNodeInfo(
            param0: android.view.accessibility.AccessibilityNodeInfo
          ): void;
          public setExpansionDirection(param0: number): void;
          public onApplyWindowInsets(
            param0: android.view.WindowInsets
          ...
          public addView(
            param0: android.view.View,
            param1: android.view.ViewGroup.LayoutParams
          ): void;
        ...
        export module CardFrame {
          export class EdgeFade {
            public static class: java.lang.Class<
              android.support.wearable.view.CardFrame.EdgeFade
            >;
            public constructor();
          }
        }
      ...
      export module view {
        ...
        export module CircledImageView {
          export class OvalShadowPainter {
            public static class: java.lang.Class<
              android.support.wearable.view.CircledImageView.OvalShadowPainter
            >;
          }
        }
      }
      ...
      export module view {
        ...
        export module CircularButton {
          export class CircleOutlineProvider {
            public static class: java.lang.Class<
              android.support.wearable.view.CircularButton.CircleOutlineProvider
            >;
    ...
    export module wearable {
      export module view {
        export class ConfirmationOverlay {
          ...
          public setFinishedAnimationListener(
            param0: android.support.wearable.view.ConfirmationOverlay.FinishedAnimationListener
          ): android.support.wearable.view.ConfirmationOverlay;
        ...
        export module ConfirmationOverlay {
          export class FinishedAnimationListener {
             ...
             */
            public constructor(implementation: { onAnimationFinished(): void });
            public constructor();
            public onAnimationFinished(): void;
          }
    ...
    export module wearable {
      export module view {
        export class CrossfadeDrawable {
          ...
          public setColorFilter(
            param0: number,
            param1: android.graphics.PorterDuff.Mode
          ): void;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class CurvedChildLayoutManager extends android.support.wearable
          .view.WearableRecyclerView.ChildLayoutManager {
          public static class: java.lang.Class<
          ...
          public updateChild(
            param0: android.view.View,
            param1: android.support.wearable.view.WearableRecyclerView
          ): void;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class DefaultOffsettingHelper extends android.support.wearable
          .view.WearableRecyclerView.OffsettingHelper {
          public static class: java.lang.Class<
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class DelayedConfirmationView extends android.support.wearable
          .view.CircledImageView {
          public static class: java.lang.Class<
            android.support.wearable.view.DelayedConfirmationView
          >;
          public setListener(
            param0: android.support.wearable.view.DelayedConfirmationView.DelayedConfirmationListener
          ): void;
          public onTouchEvent(param0: android.view.MotionEvent): boolean;
          public constructor(
            param0: android.content.Context,
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class DotsPageIndicator
          implements
            android.support.wearable.view.GridViewPager.OnPageChangeListener,
          ...
          public setOnPageChangeListener(
            param0: android.support.wearable.view.GridViewPager.OnPageChangeListener
          ): void;
          ...
          public setOnAdapterChangeListener(
            param0: android.support.wearable.view.GridViewPager.OnAdapterChangeListener
          ): void;
          public constructor(param0: android.content.Context);
          public setPager(
            param0: android.support.wearable.view.GridViewPager
          ): void;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export abstract class FragmentGridPagerAdapter extends android.support
          .wearable.view.GridPagerAdapter {
          public static class: java.lang.Class<
          ...
          public restoreFragment(
            param0: android.app.Fragment,
            param1: android.app.FragmentTransaction
          ): void;
          public applyItemPosition(
            param0: any,
            param1: android.graphics.Point
          ): void;
          public isViewFromObject(
            param0: android.view.View,
            param1: any
          ...
          public getBackgroundForPage(
            param0: number,
            param1: number
          ): android.graphics.drawable.Drawable;
        }
        export module FragmentGridPagerAdapter {
          export class BackgroundObserver extends android.support.wearable.view
        ...
        export class GridPageOptions {
          ...
          public constructor(implementation: {
            ...
            setBackgroundListener(
              param0: android.support.wearable.view.GridPageOptions.BackgroundListener
            ): void;
          });
          public constructor();
          public setBackgroundListener(
            param0: android.support.wearable.view.GridPageOptions.BackgroundListener
          ): void;
          public getBackground(): android.graphics.drawable.Drawable;
        }
    ...
    export module wearable {
      export module view {
        export abstract class GridPagerAdapter {
          ...
          public restoreState(
            param0: android.os.Parcelable,
            param1: java.lang.ClassLoader
          ): void;
          ...
          public getBackgroundForRow(
            param0: number
          ): android.graphics.drawable.Drawable;
          public getItemPosition(param0: any): android.graphics.Point;
          public constructor();
          public unregisterDataSetObserver(
            param0: android.database.DataSetObserver
          ): void;
          public notifyPageBackgroundChanged(
            param0: number,
            param1: number
          ): void;
          public destroyItem(
        ...
        export module GridPagerAdapter {
          ...
          export class OnBackgroundChangeListener {
            ...
            public constructor();
            public onPageBackgroundChanged(
              param0: number,
              param1: number
            ): void;
            public onRowBackgroundChanged(param0: number): void;
      ...
      export module view {
        export class GridViewPager {
          ...
          public setOnApplyWindowInsetsListener(
            param0: android.view.View.OnApplyWindowInsetsListener
          ): void;
          public onPageScrolled(
            param0: number,
            param1: number,
          ...
          public dispatchApplyWindowInsets(
            param0: android.view.WindowInsets
          ): android.view.WindowInsets;
          public onAttachedToWindow(): void;
          ...
          public measureChild(
            param0: android.view.View,
            param1: android.support.wearable.view.GridViewPager.LayoutParams
          ): void;
          public constructor(
            param0: android.content.Context,
            param1: android.util.AttributeSet
        ...
        export module GridViewPager {
          export class DragFrictionInterpolator {
            public static class: java.lang.Class<
              android.support.wearable.view.GridViewPager.DragFrictionInterpolator
            >;
            public constructor();
            public constructor(param0: number);
          ...
          export class ItemInfo {
            public static class: java.lang.Class<
              android.support.wearable.view.GridViewPager.ItemInfo
            >;
            public toString(): string;
          }
          export class LayoutParams {
          ...
          export class PagerObserver {
            public static class: java.lang.Class<
              android.support.wearable.view.GridViewPager.PagerObserver
            >;
          ...
          export class SavedState {
            public static class: java.lang.Class<
              android.support.wearable.view.GridViewPager.SavedState
            >;
            public static CREATOR: android.os.Parcelable.Creator<
              android.support.wearable.view.GridViewPager.SavedState
            >;
    ...
    export module wearable {
      export module view {
        export class ObservableScrollView {
          ...
          >;
          public setOnScrollListener(
            param0: android.support.wearable.view.ObservableScrollView.OnScrollListener
          ): void;
          public constructor(
            param0: android.content.Context,
            param1: android.util.AttributeSet
    ...
    export module wearable {
      export module view {
        export class ProgressSpinner {
          ...
          public showWithAnimation(
            param0: number,
            param1: android.animation.AnimatorListenerAdapter
          ): void;
          ...
          public hide(): void;
          public hideWithAnimation(
            param0: android.animation.AnimatorListenerAdapter
          ): void;
        }
        export module ProgressSpinner {
          export class ProgressDrawable {
            public static class: java.lang.Class<
              android.support.wearable.view.ProgressSpinner.ProgressDrawable
            >;
            public draw(param0: android.graphics.Canvas): void;
            public setColorFilter(param0: android.graphics.ColorFilter): void;
            public getOpacity(): number;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class RecyclerViewMergeAdapter extends android.support.v7.widget
          .RecyclerView.Adapter<
          android.support.v7.widget.RecyclerView.ViewHolder
        > {
          public static class: java.lang.Class<
            android.support.wearable.view.RecyclerViewMergeAdapter
          >;
          public getAdapterForPosition(
            param0: number
          ): android.support.v7.widget.RecyclerView.Adapter<any>;
          public onFailedToRecycleView(
            param0: android.support.v7.widget.RecyclerView.ViewHolder
          ): boolean;
          public getParentPosition(
            param0: android.support.v7.widget.RecyclerView.Adapter,
            param1: number
          ): number;
          public getAdapterPosition(
            param0: android.support.v7.widget.RecyclerView.Adapter<any>
          ): number;
          public onViewAttachedToWindow(
            param0: android.support.v7.widget.RecyclerView.ViewHolder
          ): void;
          public getChildPosition(param0: number): number;
          public setHasStableIds(param0: boolean): void;
          public onViewRecycled(
            param0: android.support.v7.widget.RecyclerView.ViewHolder
          ): void;
          public removeAdapter(
            param0: android.support.v7.widget.RecyclerView.Adapter<any>
          ): void;
          public onAttachedToRecyclerView(
          ...
          public moveAdapter(
            param0: number,
            param1: android.support.v7.widget.RecyclerView.Adapter<any>
          ): void;
          public constructor();
          public onViewDetachedFromWindow(
            param0: android.support.v7.widget.RecyclerView.ViewHolder
          ): void;
          ...
          public onDetachedFromRecyclerView(
            param0: android.support.v7.widget.RecyclerView
          ): void;
          public addAdapter(
            param0: android.support.v7.widget.RecyclerView.Adapter
        ...
        export module RecyclerViewMergeAdapter {
          export class AdapterHolder {
            public static class: java.lang.Class<
              android.support.wearable.view.RecyclerViewMergeAdapter.AdapterHolder
            >;
            public constructor(
              param0: number,
              param1: android.support.v7.widget.RecyclerView.Adapter
            );
          }
          export class ForwardingDataSetObserver {
            public static class: java.lang.Class<
              android.support.wearable.view.RecyclerViewMergeAdapter.ForwardingDataSetObserver
            >;
            public constructor(
              param0: android.support.wearable.view.RecyclerViewMergeAdapter,
              param1: android.support.wearable.view.RecyclerViewMergeAdapter.AdapterHolder
            );
            public onChanged(): void;
    ...
    export module wearable {
      export module view {
        export class ResourcesUtil {
          public static class: java.lang.Class<
            android.support.wearable.view.ResourcesUtil
          >;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class SwipeDismissFrameLayout extends android.support.wearable
          .internal.view.SwipeDismissLayout {
          public static class: java.lang.Class<
          ...
          public removeCallback(
            param0: android.support.wearable.view.SwipeDismissFrameLayout.Callback
          ): void;
          public reset(): void;
          public constructor(param0: android.content.Context);
        ...
        export module SwipeDismissFrameLayout {
          export abstract class Callback {
            ...
            public onDismissed(
              param0: android.support.wearable.view.SwipeDismissFrameLayout
            ): void;
            public onSwipeCancelled(): void;
            public onSwipeStart(): void;
          }
          export class MyOnDismissedListener extends android.support.wearable
            .internal.view.SwipeDismissLayout.OnDismissedListener {
            public static class: java.lang.Class<
              android.support.wearable.view.SwipeDismissFrameLayout.MyOnDismissedListener
            >;
            public onDismissed(
              param0: android.support.wearable.internal.view.SwipeDismissLayout
            ): void;
          }
          export class MyOnPreSwipeListener extends android.support.wearable
            .internal.view.SwipeDismissLayout.OnPreSwipeListener {
            public static class: java.lang.Class<
              android.support.wearable.view.SwipeDismissFrameLayout.MyOnPreSwipeListener
            >;
            public onPreSwipe(param0: number, param1: number): boolean;
          }
          export class MyOnSwipeProgressChangedListener extends android.support
            .wearable.internal.view.SwipeDismissLayout
            .OnSwipeProgressChangedListener {
            public static class: java.lang.Class<
              android.support.wearable.view.SwipeDismissFrameLayout.MyOnSwipeProgressChangedListener
            >;
            public onSwipeProgressChanged(
              param0: android.support.wearable.internal.view.SwipeDismissLayout,
              param1: number,
    ...
    export module wearable {
      export module view {
        export class WatchViewStub {
          ...
          public onAttachedToWindow(): void;
          public setOnLayoutInflatedListener(
            param0: android.support.wearable.view.WatchViewStub.OnLayoutInflatedListener
          ): void;
        }
        export module WatchViewStub {
          export class OnLayoutInflatedListener {
            ...
            public constructor(implementation: {
              onLayoutInflated(
                param0: android.support.wearable.view.WatchViewStub
              ): void;
            });
            public constructor();
            public onLayoutInflated(
              param0: android.support.wearable.view.WatchViewStub
            ): void;
          }
        }
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export class WearableDialogActivity
          extends android.support.wearable.activity.WearableActivity
          implements
            android.support.wearable.view.ObservableScrollView
              .OnScrollListener {
          public static class: java.lang.Class<
            android.support.wearable.view.WearableDialogActivity
          >;
          public onNeutralButtonClick(): void;
          public onApplyWindowInsets(
            param0: android.view.View,
            param1: android.view.WindowInsets
          ): android.view.WindowInsets;
    ...
    export module wearable {
      export module view {
        export class WearableDialogHelper {
          ...
          public constructor(
            param0: android.content.res.Resources,
            param1: android.content.res.Resources.Theme
          );
        }
    ...
    export module wearable {
      export module view {
        export class WearableFrameLayout {
          ...
          public measureChildWithMargins(
            param0: android.view.View,
            param1: number,
            param2: number,
            param3: number,
          ...
          public setVisibility(param0: number): void;
          public setForegroundTintMode(
            param0: android.graphics.PorterDuff.Mode
          ): void;
          public onLayout(
            param0: boolean,
            param1: number,
        ...
        export module WearableFrameLayout {
          export class LayoutParams {
            ...
            public constructor(
              param0: android.support.wearable.view.WearableFrameLayout.LayoutParams
            );
            public constructor(param0: number, param1: number, param2: number);
            public constructor(param0: number, param1: number);
          }
    ...
    export module wearable {
      export module view {
        export class WearableListView {
          ...
          public smoothScrollToPosition(
            param0: number,
            param1: android.support.v7.widget.RecyclerView.SmoothScroller
          ): void;
          public removeOnScrollListener(
            param0: android.support.wearable.view.WearableListView.OnScrollListener
          ): void;
          ...
          public onAttachedToWindow(): void;
          public getChildViewHolder(
            param0: android.view.View
          ): android.support.wearable.view.WearableListView.ViewHolder;
          public addOnCentralPositionChangedListener(
            param0: android.support.wearable.view.WearableListView.OnCentralPositionChangedListener
          ): void;
          ...
          public removeOnCentralPositionChangedListener(
            param0: android.support.wearable.view.WearableListView.OnCentralPositionChangedListener
          ): void;
          public setClickListener(
            param0: android.support.wearable.view.WearableListView.ClickListener
          ): void;
          public getMaximizeSingleItem(): boolean;
          public animateToInitialPosition(param0: java.lang.Runnable): void;
          public setOverScrollListener(
            param0: android.support.wearable.view.WearableListView.OnOverScrollListener
          ): void;
          ...
          public addOnScrollListener(
            param0: android.support.wearable.view.WearableListView.OnScrollListener
          ): void;
          public onGenericMotionEvent(
            param0: android.view.MotionEvent
          ): boolean;
          public onInterceptTouchEvent(
            param0: android.view.MotionEvent
        ...
        export module WearableListView {
          export abstract class Adapter extends android.support.v7.widget
            .RecyclerView.Adapter<
            android.support.wearable.view.WearableListView.ViewHolder
          > {
            public static class: java.lang.Class<
          ...
          export class ClickListener {
            ...
            public constructor(implementation: {
              onClick(
                param0: android.support.wearable.view.WearableListView.ViewHolder
              ): void;
          ...
          export abstract class GenericAdapter<T> extends android.support.v7
            .widget.RecyclerView.Adapter<any> {
            public static class: java.lang.Class<
              android.support.wearable.view.WearableListView.GenericAdapter<any>
            >;
            public constructor();
          }
          export class LayoutManager {
            public static class: java.lang.Class<
              android.support.wearable.view.WearableListView.LayoutManager
            >;
            ...
            public setCustomSmoothScroller(
              param0: android.support.v7.widget.RecyclerView.SmoothScroller
            ): void;
            ...
            public getDefaultSmoothScroller(
              param0: android.support.v7.widget.RecyclerView
          ...
          export class OnChangeObserver {
            public static class: java.lang.Class<
              android.support.wearable.view.WearableListView.OnChangeObserver
            >;
            public setListView(
              param0: android.support.wearable.view.WearableListView
            ): void;
            public onLayoutChange(
              param0: android.view.View,
              param1: number,
          ...
          export class OnOverScrollListener {
             ...
             */
            public constructor(implementation: { onOverScroll(): void });
            public constructor();
          ...
          export class SetScrollVerticallyProperty extends android.util
            .Property<
            android.support.wearable.view.WearableListView,
            java.lang.Integer
          > {
            public static class: java.lang.Class<
              android.support.wearable.view.WearableListView.SetScrollVerticallyProperty
            >;
            public constructor();
            public get(
              param0: android.support.wearable.view.WearableListView
          ...
          export class SmoothScroller {
            public static class: java.lang.Class<
              android.support.wearable.view.WearableListView.SmoothScroller
            >;
            public computeScrollVectorForPosition(
              param0: number
            ): android.graphics.PointF;
            public calculateDtToFit(
              param0: number,
              param1: number,
              param2: number,
              param3: number,
            ...
            public constructor(
              param0: android.content.Context,
              param1: android.support.wearable.view.WearableListView.LayoutManager
            );
            public calculateSpeedPerPixel(
              param0: android.util.DisplayMetrics
            ): number;
            public onStart(): void;
          }
    ...
    export module wearable {
      export module view {
        export class WearableRecyclerView {
          ...
          public setOffsettingHelper(
            param0: android.support.wearable.view.WearableRecyclerView.OffsettingHelper
          ): void;
          public constructor(param0: android.content.Context);
        ...
        export module WearableRecyclerView {
          ...
          export class OffsettingLinearLayoutManager {
            ...
            public constructor(
              param0: android.support.wearable.view.WearableRecyclerView,
      ...
      export module view {
        export module drawer {
          export class FlingWatcher {
            ...
            public constructor(
              param0: android.support.wearable.view.drawer.FlingWatcher.FlingListener
            );
          }
      ...
      export module view {
        export module drawer {
          export class PageIndicatorView {
            public static class: java.lang.Class<
              android.support.wearable.view.drawer.PageIndicatorView
            >;
            public getDotShadowRadius(): number;
            public getDotFadeOutDuration(): number;
            public getDotRadiusSelected(): number;
      ...
      export module view {
        export module drawer {
          export class ViewDragHelper {
            public static class: java.lang.Class<
              android.support.wearable.view.drawer.ViewDragHelper
            >;
            ...
            public static create(
              param0: android.view.ViewGroup,
              param1: android.support.wearable.view.drawer.ViewDragHelper.Callback
            ): android.support.wearable.view.drawer.ViewDragHelper;
            public flingCapturedView(
              param0: number,
              param1: number,
              param2: number,
              param3: number
            ...
            public abort(): void;
            public shouldInterceptTouchEvent(
              param0: android.view.MotionEvent
            ): boolean;
            ...
            public static create(
              param0: android.view.ViewGroup,
              param1: number,
              param2: android.support.wearable.view.drawer.ViewDragHelper.Callback
            ): android.support.wearable.view.drawer.ViewDragHelper;
            public continueSettling(param0: boolean): boolean;
            public captureChildView(
              param0: android.view.View,
              param1: number
            ): void;
          ...
          export module ViewDragHelper {
            export abstract class Callback {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.ViewDragHelper.Callback
              >;
              public constructor();
              public clampViewPositionHorizontal(
                param0: android.view.View,
                param1: number,
                param2: number
              ): number;
              ...
              public getViewHorizontalDragRange(
                param0: android.view.View
              ): number;
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export module drawer {
          export class WearableActionDrawer extends android.support.wearable
            .view.drawer.WearableDrawerView {
            public static class: java.lang.Class<
            ...
            public setOnMenuItemClickListener(
              param0: android.support.wearable.view.drawer.WearableActionDrawer.OnMenuItemClickListener
            ): void;
          ...
          export module WearableActionDrawer {
            export class ActionItemViewHolder {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableActionDrawer.ActionItemViewHolder
              >;
              public view: android.view.View;
              public iconView: android.widget.ImageView;
              public textView: android.widget.TextView;
              public constructor(
                param0: android.support.wearable.view.drawer.WearableActionDrawer,
                param1: android.view.View
              );
            }
            ...
            > {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableActionDrawer.ActionListAdapter
              >;
              public static TYPE_ACTION: number;
              public static TYPE_TITLE: number;
              public constructor(
                param0: android.support.wearable.view.drawer.WearableActionDrawer,
                param1: android.view.Menu
              );
              public getItemViewType(param0: number): number;
              public getItemCount(): number;
              public onBindViewHolder(
            ...
            export class TitleViewHolder {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableActionDrawer.TitleViewHolder
              >;
              public view: android.view.View;
              public textView: android.widget.TextView;
              public constructor(param0: android.view.View);
      ...
      export module view {
        export module drawer {
          export class WearableActionDrawerMenu {
            public static class: java.lang.Class<
              android.support.wearable.view.drawer.WearableActionDrawerMenu
            >;
            public add(
              param0: number,
              param1: number,
            ...
            public constructor(
              param0: android.content.Context,
              param1: android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuListener
            );
          ...
          export module WearableActionDrawerMenu {
            export class WearableActionDrawerMenuItem {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuItem
              >;
              ...
              public constructor(
                ...
                param1: number,
                param2: string,
                param3: android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuItem.MenuItemChangedListener
              );
            ...
            export module WearableActionDrawerMenuItem {
              export class MenuItemChangedListener {
                public static class: java.lang.Class<
                  android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuItem.MenuItemChangedListener
                >;
                /**
                ...
                public constructor(implementation: {
                  itemChanged(
                    param0: android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuItem
                  ): void;
                });
                public constructor();
                public itemChanged(
            ...
            export class WearableActionDrawerMenuListener {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableActionDrawerMenu.WearableActionDrawerMenuListener
              >;
              /**
        ...
        export module drawer {
          export class WearableDrawerLayout
            ...
            public setDrawerStateCallback(
              param0: android.support.wearable.view.drawer.WearableDrawerLayout.DrawerStateCallback
            ): void;
            public onSizeChanged(
              param0: number,
              param1: number,
            ...
            public peekDrawer(
              param0: android.support.wearable.view.drawer.WearableDrawerView
            ): void;
            public constructor(
              param0: android.content.Context,
              param1: android.util.AttributeSet,
          ...
          export module WearableDrawerLayout {
            export class BottomDrawerDraggerCallback extends android.support
              .wearable.view.drawer.WearableDrawerLayout.DrawerDraggerCallback {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableDrawerLayout.BottomDrawerDraggerCallback
              >;
            ...
            export class ClosePeekRunnable {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableDrawerLayout.ClosePeekRunnable
              >;
              public run(): void;
            }
            export abstract class DrawerDraggerCallback extends android.support
              .wearable.view.drawer.ViewDragHelper.Callback {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableDrawerLayout.DrawerDraggerCallback
              >;
              public getDrawerView(): android.support.wearable.view.drawer.WearableDrawerView;
              public tryCaptureView(
                param0: android.view.View,
            ...
            export class TopDrawerDraggerCallback extends android.support
              .wearable.view.drawer.WearableDrawerLayout.DrawerDraggerCallback {
              public static class: java.lang.Class<
                android.support.wearable.view.drawer.WearableDrawerLayout.TopDrawerDraggerCallback
              >;
              public getDrawerView(): android.support.wearable.view.drawer.WearableDrawerView;
              public clampViewPositionVertical(
                param0: android.view.View,
...
declare module android {
  export module support {
    export module wearable {
      export module view {
        export module drawer {
          export class WearableNavigationDrawer extends android.support.wearable
            .view.drawer.WearableDrawerView {
            public static class: java.lang.Class<
            ...
            public constructor(
              param0: android.content.Context,
              param1: android.support.wearable.internal.view.drawer.WearableNavigationDrawerPresenter,
              param2: android.view.GestureDetector
            );
            public constructor(
              param0: android.content.Context,
              param1: android.util.AttributeSet,
  ...
  export module support {
    export module wearable {
      export module watchface {
        export abstract class CanvasWatchFaceService extends android.support
          .wearable.watchface.WatchFaceService {
          public static class: java.lang.Class<
        ...
        export module CanvasWatchFaceService {
          export class Engine extends android.support.wearable.watchface
            .WatchFaceService.Engine {
            public static class: java.lang.Class<
              android.support.wearable.watchface.CanvasWatchFaceService.Engine
            >;
            public constructor(
              param0: android.support.wearable.watchface.WatchFaceService
            );
            public onDestroy(): void;
            public invalidate(): void;
            public onVisibilityChanged(param0: boolean): void;
            public constructor(
              param0: android.support.wearable.watchface.CanvasWatchFaceService
            );
            public onDraw(
              param0: android.graphics.Canvas,
              param1: android.graphics.Rect
            ...
            public onSurfaceChanged(
              param0: android.view.SurfaceHolder,
              param1: number,
              param2: number,
              param3: number
            ): void;
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export abstract class Gles2WatchFaceService extends android.support
          .wearable.watchface.WatchFaceService {
          public static class: java.lang.Class<
        ...
        export module Gles2WatchFaceService {
          export class Engine extends android.support.wearable.watchface
            ...
            public constructor(
              param0: android.support.wearable.watchface.Gles2WatchFaceService
            );
            public chooseEglConfig(
              param0: android.opengl.EGLDisplay
            ): android.opengl.EGLConfig;
            public createWindowSurface(
              param0: android.opengl.EGLDisplay,
              param1: android.opengl.EGLConfig,
              param2: android.view.SurfaceHolder
    ...
    export module wearable {
      export module watchface {
        export class IWatchFaceService {
          ...
          public constructor(implementation: {
            setStyle(
              param0: android.support.wearable.watchface.WatchFaceStyle
            ): void;
            ...
            updateDecomposition(
              param0: android.support.wearable.watchface.decomposition.WatchFaceDecomposition
            ): void;
          });
          public constructor();
          public setDefaultComplicationProvider(
            param0: number,
            param1: android.content.ComponentName,
            param2: number
          ): void;
          public setDefaultSystemComplicationProvider(
            param0: number,
            param1: number,
            param2: number
          ): void;
          ...
          public setActiveComplications(
            param0: native.Array<number>,
            param1: boolean
          ): void;
          public setContentDescriptionLabels(
            param0: native.Array<
              android.support.wearable.watchface.accessibility.ContentDescriptionLabel
            >
          ): void;
          public updateDecomposition(
            param0: android.support.wearable.watchface.decomposition.WatchFaceDecomposition
          ): void;
        }
        export module IWatchFaceService {
          export abstract class Stub
            extends android.support.wearable.internal.aidl.BaseStub
            implements android.support.wearable.watchface.IWatchFaceService {
            public static class: java.lang.Class<
        ...
        export module WatchFaceService {
          export abstract class Engine {
            ...
            public onCommand(
              ...
              param2: number,
              param3: number,
              param4: android.os.Bundle,
              param5: boolean
            ): android.os.Bundle;
            public onComplicationDataUpdate(
              param0: number,
              param1: android.support.wearable.complications.ComplicationData
            ): void;
            public onPeekCardPositionUpdate(
              param0: android.graphics.Rect
            ): void;
          ...
          export class ProviderConfig {
            public static class: java.lang.Class<
              android.support.wearable.watchface.WatchFaceService.ProviderConfig
            >;
      ...
      export module watchface {
        ...
        export module WatchFaceStyle {
          export class Builder {
            ...
            >;
            public setCardPeekMode(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public static forActivity(
              param0: android.app.Activity
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setPeekOpacityMode(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setHideNotificationIndicator(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            ...
            public setShowSystemUiTime(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public static forDefault(): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setViewProtection(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setShowUnreadCountIndicator(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setAcceptsTapEvents(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setBackgroundVisibility(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setCardProgressMode(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setHotwordIndicatorGravity(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setHideHotwordIndicator(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setAmbientPeekMode(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public static forComponentName(
              param0: android.content.ComponentName
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public constructor(param0: android.app.Service);
            public setHideStatusBar(
              param0: boolean
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setStatusBarGravity(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
            public setViewProtectionMode(
              param0: number
            ): android.support.wearable.watchface.WatchFaceStyle.Builder;
          }
        }
      ...
      export module watchface {
        export module accessibility {
          export class AccessibilityUtils {
            ...
            >;
            public constructor();
            public static generateContentDescription(
              param0: android.content.Context,
              param1: android.support.wearable.complications.ComplicationData
            ): android.support.wearable.complications.TimeDependentText;
            public static makeTimeAsComplicationText(
              param0: android.content.Context
            ): android.support.wearable.complications.ComplicationText;
          }
        }
      ...
      export module watchface {
        export module accessibility {
          export class ContentDescriptionLabel {
            ...
            public constructor(
              param0: android.graphics.Rect,
              param1: android.support.wearable.complications.ComplicationTextTemplate
            );
            public constructor(
              param0: android.content.Context,
              param1: android.graphics.Rect,
    ...
    export module wearable {
      export module watchface {
        export module decomposition {
          export abstract class BaseComponent extends android.support.wearable
            .watchface.decomposition.WatchFaceDecomposition.Component {
            public static class: java.lang.Class<
          ...
          export module BaseComponent {
            export abstract class BaseBuilder<T, K> extends java.lang.Object {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.BaseComponent.BaseBuilder<
                  any,
                  any
                >
              >;
            ...
            export class ComponentFactory<T> extends java.lang.Object {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.BaseComponent.ComponentFactory<
                  any
                >
              >;
              /**
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decomposition {
          export abstract class BaseDrawnComponent
            extends android.support.wearable.watchface.decomposition
              .BaseComponent
            implements
              android.support.wearable.watchface.decomposition
                .WatchFaceDecomposition.DrawnComponent {
            public static class: java.lang.Class<
          ...
          export module BaseDrawnComponent {
            export abstract class BaseDrawnBuilder<T, K> extends android.support
              .wearable.watchface.decomposition.BaseComponent.BaseBuilder<
              any,
              any
            > {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.BaseDrawnComponent.BaseDrawnBuilder<
                  any,
                  any
                >
              >;
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decomposition {
          export class ComplicationComponent extends android.support.wearable
            .watchface.decomposition.BaseDrawnComponent {
            public static class: java.lang.Class<
          ...
          export module ComplicationComponent {
            export class Builder extends android.support.wearable.watchface
              .decomposition.BaseDrawnComponent.BaseDrawnBuilder<
              android.support.wearable.watchface.decomposition.ComplicationComponent.Builder,
              android.support.wearable.watchface.decomposition.ComplicationComponent
            > {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.ComplicationComponent.Builder
              ...
              public constructor();
              public validate(): void;
              public setDefaultSystemProvider(
                param0: number,
                param1: number
              ): android.support.wearable.watchface.decomposition.ComplicationComponent.Builder;
              public setBounds(
                param0: android.graphics.RectF
              ): android.support.wearable.watchface.decomposition.ComplicationComponent.Builder;
              public setWatchFaceComplicationId(
                param0: number
              ): android.support.wearable.watchface.decomposition.ComplicationComponent.Builder;
              public setComplicationDrawable(
                param0: android.support.wearable.complications.rendering.ComplicationDrawable
              ): android.support.wearable.watchface.decomposition.ComplicationComponent.Builder;
              public setComplicationTypes(
                param0: native.Array<number>
              ): android.support.wearable.watchface.decomposition.ComplicationComponent.Builder;
            }
          }
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decomposition {
          export class FontComponent extends android.support.wearable.watchface
            .decomposition.BaseComponent {
            public static class: java.lang.Class<
          ...
          export module FontComponent {
            export class Builder extends android.support.wearable.watchface
              .decomposition.BaseComponent.BaseBuilder<
              android.support.wearable.watchface.decomposition.FontComponent.Builder,
              android.support.wearable.watchface.decomposition.FontComponent
            > {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.FontComponent.Builder
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decomposition {
          export class ImageComponent extends android.support.wearable.watchface
            .decomposition.BaseDrawnComponent {
            public static class: java.lang.Class<
          ...
          export module ImageComponent {
            export class Builder extends android.support.wearable.watchface
              .decomposition.BaseDrawnComponent.BaseDrawnBuilder<
              android.support.wearable.watchface.decomposition.ImageComponent.Builder,
              android.support.wearable.watchface.decomposition.ImageComponent
            > {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.ImageComponent.Builder
              ...
              public setPivot(
                param0: android.graphics.PointF
              ): android.support.wearable.watchface.decomposition.ImageComponent.Builder;
              public validate(): void;
              public setBounds(
                param0: android.graphics.RectF
              ): android.support.wearable.watchface.decomposition.ImageComponent.Builder;
              public setOffsetDegrees(
                param0: number
              ): android.support.wearable.watchface.decomposition.ImageComponent.Builder;
              public setDegreesPerDay(
                param0: number
              ): android.support.wearable.watchface.decomposition.ImageComponent.Builder;
              public constructor(param0: number);
              public setDegreesPerStep(
                param0: number
              ): android.support.wearable.watchface.decomposition.ImageComponent.Builder;
            }
          }
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decomposition {
          export class NumberComponent extends android.support.wearable
            .watchface.decomposition.BaseDrawnComponent {
            public static class: java.lang.Class<
          ...
          export module NumberComponent {
            export class Builder extends android.support.wearable.watchface
              .decomposition.BaseDrawnComponent.BaseDrawnBuilder<
              android.support.wearable.watchface.decomposition.NumberComponent.Builder,
              android.support.wearable.watchface.decomposition.NumberComponent
            > {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.NumberComponent.Builder
              ...
              public setFontComponent(
                param0: android.support.wearable.watchface.decomposition.FontComponent
              ): android.support.wearable.watchface.decomposition.NumberComponent.Builder;
              public setLowestValue(
                param0: number
              ): android.support.wearable.watchface.decomposition.NumberComponent.Builder;
              public setFontComponentId(
                param0: number
              ): android.support.wearable.watchface.decomposition.NumberComponent.Builder;
              public setMinDigitsShown(
                param0: number
              ): android.support.wearable.watchface.decomposition.NumberComponent.Builder;
              public setTimeOffsetMs(
                param0: number
              ): android.support.wearable.watchface.decomposition.NumberComponent.Builder;
              public constructor(param0: number);
            }
      ...
      export module watchface {
        export module decomposition {
          export class WatchFaceDecomposition {
            public static class: java.lang.Class<
              android.support.wearable.watchface.decomposition.WatchFaceDecomposition
            >;
            public static MAX_COMPONENT_ID: number;
            public static CREATOR: android.os.Parcelable.Creator<
              android.support.wearable.watchface.decomposition.WatchFaceDecomposition
            >;
            public getImageComponents(): java.util.List<
              android.support.wearable.watchface.decomposition.ImageComponent
            >;
            public describeContents(): number;
            public getComplicationComponents(): java.util.List<
              android.support.wearable.watchface.decomposition.ComplicationComponent
            >;
            public writeToParcel(
              param0: android.os.Parcel,
            ...
            public getFontComponents(): java.util.List<
              android.support.wearable.watchface.decomposition.FontComponent
            >;
            public getNumberComponents(): java.util.List<
              android.support.wearable.watchface.decomposition.NumberComponent
            >;
          }
          export module WatchFaceDecomposition {
            export class Builder {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Builder
              >;
              public constructor();
              public addComplicationComponents(
                param0: native.Array<
                  android.support.wearable.watchface.decomposition.ComplicationComponent
                >
              ): android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Builder;
              public addFontComponents(
                param0: native.Array<
                  android.support.wearable.watchface.decomposition.FontComponent
                >
              ): android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Builder;
              public addNumberComponents(
                param0: native.Array<
                  android.support.wearable.watchface.decomposition.NumberComponent
                >
              ): android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Builder;
              public addImageComponents(
                param0: native.Array<
                  android.support.wearable.watchface.decomposition.ImageComponent
                >
              ): android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Builder;
            ...
            export class Component {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.WatchFaceDecomposition.Component
              >;
              /**
            ...
            export class DrawnComponent extends android.support.wearable
              .watchface.decomposition.WatchFaceDecomposition.Component {
              public static class: java.lang.Class<
                android.support.wearable.watchface.decomposition.WatchFaceDecomposition.DrawnComponent
              >;
              /**
      ...
      export module watchface {
        export module decompositionface {
          export class CoordConverter {
            ...
            >;
            public getPixelRectFromProportional(
              param0: android.graphics.RectF,
              param1: android.graphics.Rect
            ): void;
            public constructor();
      ...
      export module watchface {
        export module decompositionface {
          export abstract class DecompositionConfigActivity {
            ...
            public buildDecompositionForWatchFace(
              param0: string
            ): android.support.wearable.watchface.decomposition.WatchFaceDecomposition;
            public onCreate(param0: android.os.Bundle): void;
          }
      ...
      export module watchface {
        export module decompositionface {
          export class DecompositionConfigView {
            ...
            public setDecomposition(
              param0: android.support.wearable.watchface.decomposition.WatchFaceDecomposition
            ): void;
            public setProviderInfo(
              param0: number,
              param1: android.support.wearable.complications.ComplicationProviderInfo
            ): void;
            public constructor(param0: android.content.Context);
            public setOnComplicationTapListener(
              param0: android.support.wearable.watchface.decompositionface.DecompositionConfigView.OnComplicationTapListener
            ): void;
          }
      ...
      export module watchface {
        export module decompositionface {
          export class DecompositionDrawable {
            public static class: java.lang.Class<
              android.support.wearable.watchface.decompositionface.DecompositionDrawable
            >;
            public draw(param0: android.graphics.Canvas): void;
            public setColorFilter(param0: android.graphics.ColorFilter): void;
            public setInAmbientMode(param0: boolean): void;
            ...
            public setAlpha(param0: number): void;
            public constructor(param0: android.content.Context);
            public static calculateStepIntervalMs(
              param0: android.support.wearable.watchface.decomposition.WatchFaceDecomposition,
              param1: number
            ): number;
            public onBoundsChange(param0: android.graphics.Rect): void;
...
declare module android {
  export module support {
    export module wearable {
      export module watchface {
        export module decompositionface {
          export abstract class DecompositionWatchFaceService extends android
            .support.wearable.watchface.CanvasWatchFaceService {
            public static class: java.lang.Class<
          ...
          export module DecompositionWatchFaceService {
            export class Engine extends android.support.wearable.watchface
              ...
              public onTimeTick(): void;
              public constructor(
                param0: android.support.wearable.watchface.decompositionface.DecompositionWatchFaceService
              );
              public onTapCommand(
                param0: number,
                param1: number,
      ...
      export module wearable {
        export module intent {
          export class RemoteIntent {
            ...
            public static startRemoteActivity(
              param0: globalAndroid.content.Context,
              param1: globalAndroid.content.Intent,
              param2: globalAndroid.os.ResultReceiver,
              param3: string
            ): void;
            public constructor();
            public static startRemoteActivity(
      ...
      export module wearable {
        export module playstore {
          export class PlayStoreAvailability {
            ...
            public constructor();
            public static getPlayStoreAvailabilityOnPhone(
              param0: globalAndroid.content.Context
            ): number;
          }
        }

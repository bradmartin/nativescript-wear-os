...
export class CircularProgressLayout extends View
  ...
  private _android: android.support.wear.widget.CircularProgressLayout;
  ...
  public createNativeView() {
    this._android = new android.support.wear.widget.CircularProgressLayout(
      this._context
    );
  ...
  public initNativeView() {
    ...
    const timerFinishedListener = new android.support.wear.widget.CircularProgressLayout.OnTimerFinishedListener(
      {
